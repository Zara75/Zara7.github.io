...
namespace WYSIWYG.Controllers
{
	public class HomeController : Controller
	{
		public ActionResult Index()
		{
			...
			//u.Update();
			string[] dirs = Directory.GetFiles(@"C:\Users\user\Dropbox\Zara(2)\ogma\project with jquery\WYSIWYG\files\" + u.Login);
		...
		public JsonResult CreateFile(string name)
		{
			...
			if (!isNameUsed && name != "")
			{
				string path = "C:\\Users\\user\\Dropbox\\Zara(2)\\ogma\\project with jquery\\WYSIWYG\\files\\" + u.Login + "\\" + name + ".txt";
